...
public class Kemalpasa extends Activity implements SensorListener,Runnable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kemalpasa);
        ...
        id = (int)myDbHelper.GetCountFindKemalpasaWords(account_id);
        
        Text= new String[id+5];
        int j=0;
        
        cr = myDbHelper.GetFindedWordsKemalpasa(account_id);
        while(cr.moveToNext()){	
        ...
        gallery.setOnItemClickListener(new OnItemClickListener() {
  	      public void onItemClick(AdapterView<?> parent, View v,int position, long id) {
  	       ...
  	       {  
  	        	...
  	        	new AlertDialog.Builder(Kemalpasa.this)
	...
	private void implement() {
		...
		facebook.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				bundle.putString("dessert_name","Kemalpasa");
		...
		hint.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(new_word )
				{
					//getting hint words
					 final int account_id = Integer.parseInt(account_ids);
					 DatabaseHelper hintHelper = new DatabaseHelper(getApplicationContext());
					 Cursor crr = hintHelper.GetNotFindedWords(account_id, 1);
					 int h=0;
				...
				int kemalpasa_puan = (int) myDbHelper.GetKemalpasaScore(account_id) - 5 ;
	    		int total_puan = (int) myDbHelper.GetTotalScore(account_id) - 5;
	    		myDbHelper.UpdateKemalpasaScore(Integer.toString(kemalpasa_puan), Integer.toString(account_id));
			 ...
			 if (s.length() > 0) {
					...
					if (k == s.length() - (s.length()-1) &&  k<=s.length()) {
						if(s.length() == 4){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 1))+"??? : " + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						new_word = false; 
							...
							if(s.length() == 4){
								new AlertDialog.Builder(Kemalpasa.this)
								.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 2))+"?? : " + meaning)
								.setPositiveButton("Tamam",
								new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
										}
						...
						if(s.length() == 4){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 3))+"? : " + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						if(s.length()==4){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 4)) + "\t\t" + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						if(s.length()==5){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 5)) + "\t\t" + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						if(s.length()==6){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() -6)) + "\t\t" + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						if(s.length()==7){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 7)) + "\t\t" + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						if(s.length()==8){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 8)) + "\t\t" + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
						...
						if(s.length()==9){
							new AlertDialog.Builder(Kemalpasa.this)
							.setTitle("İpucu").setMessage(s.substring(0, s.length()- (s.length() - 9)) + "\t\t" + meaning)
							.setPositiveButton("Tamam",
							new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int which) {
									}
		...
		leave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				bundle.putString("kemalpasa_count", Long.toString(getCount()));
				bundle.putString("muhallebi_count", null);
				bundle.putString("kazandibi_count", null);
	...
	private int getCount()
	{
		...
		final DatabaseHelper myDbHelper = new DatabaseHelper(this);
		int account_id =Integer.parseInt(account_ids);
		count = (int) myDbHelper.GetCountFindKemalpasaWords(account_id);
		myDbHelper.close();
		return count;
	}
	...
	private void DatabasedeAra(String cevapk) {
    	...
    	Cursor c1 = myDbHelper.GetFindedWordsKemalpasa(account_id);
    	...
    	while(c1.moveToNext())
    	{
    		...
    		if(cevapk.compareToIgnoreCase(c1.getString(c1.getColumnIndex("wordname"))) == 0)
    		{
    			wrong.start();
    			new AlertDialog.Builder(Kemalpasa.this)
				.setTitle("UYARI!").setMessage(c1.getString(c1.getColumnIndex("wordname")) + "Bu kelime zaten bulunmuştur!")
				.setPositiveButton("Tamam",
				new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
						}
    	...
    	Cursor c2 = myDbHelper.GetKemalpasaWords();
    	...
    	if(cevapk.compareToIgnoreCase(c2.getString(c2.getColumnIndex("wordname"))) == 0){
			...
			myDbHelper.InsertFindedWordKemalpasa(account_id,cevapk); 
    		...
    		int kemalpasa_puan = (int) myDbHelper.GetKemalpasaScore(account_id) + ((cevapk.length() * 5 )) ;
	...
	public void runAnimate()
	{
		...
		imgView = (ImageView) findViewById ( R.id.kemalpasa_anim);
        
        new CountDownTimer(75,150) {
        	
        	int[] array  = {R.drawable.kemalpasa1,R.drawable.kemalpasa2,R.drawable.kemalpasa3,
        					R.drawable.kemalpasa4,R.drawable.kemalpasa5,R.drawable.kemalpasa6,
        					R.drawable.kemalpasa7,R.drawable.kemalpasa8,R.drawable.kemalpasa9,
        					R.drawable.kemalpasa10};
