...
public class Muhallebi extends Activity implements SensorListener,Runnable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.muhallebi);
        ...
        id = (int)myDbHelper.GetCountFindMuhallebiWords(account_id);
        
        Text= new String[id+5];
        int j=0;
        
        cr = myDbHelper.GetFindedWordsMuhallebi(account_id);
        while(cr.moveToNext()){	
        ...
        gallery.setOnItemClickListener(new OnItemClickListener() {
  	      public void onItemClick(AdapterView<?> parent, View v,int position, long id) {
  	       ...
  	       {  
  	        	...
  	        	new AlertDialog.Builder(Muhallebi.this)
				.setTitle("Kelimenin Anlamý:").setMessage(word.toUpperCase() + " : " + meaning)
	...
	private void implement() {
		...
		facebook.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				bundle.putString("dessert_name","Muhallebi");
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				// Eðer ilk olarak bu harfe basýldýysa
				if (kelime.length() == 0) {
			...
			public void onClick(View arg0) {
				...
				if(new_word )
				{
					//getting hint words
					 ...
					 Cursor crr = hintHelper.GetNotFindedWords(account_id, 2);
					 int h=0;
				...
				// Button Enable - Disable Issues
					...
					int Muhallebi_puan = (int) myDbHelper.GetMuhallebiScore(account_id) - 5 ;
		 	    	int total_puan = (int) myDbHelper.GetTotalScore(account_id) - 5;
		    		myDbHelper.UpdateMuhallebiScore(Integer.toString(Muhallebi_puan), Integer.toString(account_id));
				 ...
				 if (s.length() > 0) {
						...
						if (k == s.length() - (s.length()-1) &&  k<=s.length()) {
							if(s.length() == 4){
								new AlertDialog.Builder(Muhallebi.this)
								.setTitle("Ýp Ucu:").setMessage(s.substring(0, s.length()- (s.length() - 1))+"??? : " + meaning)
								.setPositiveButton("Tamam",
								new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
										}
							...
							new_word = false; 
								...
								if(s.length() == 4){
									new AlertDialog.Builder(Muhallebi.this)
									.setTitle("Ýp Ucu:").setMessage(s.substring(0, s.length()- (s.length() - 2))+"?? : " + meaning)
									.setPositiveButton("Tamam",
									new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog, int which) {
											}
							...
							if(s.length() == 4){
								new AlertDialog.Builder(Muhallebi.this)
								.setTitle("Ýp Ucu:").setMessage(s.substring(0, s.length()- (s.length() - 3))+"? : " + meaning)
								.setPositiveButton("Tamam",
								new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
										}
							...
							if(s.length()==4){
								new AlertDialog.Builder(Muhallebi.this)
								.setTitle("Ýp Ucu:").setMessage(s.substring(0, s.length()- (s.length() - 4)) + " : " + meaning)
								.setPositiveButton("Tamam",
								new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
										}
							...
							if(s.length()==5){
								new AlertDialog.Builder(Muhallebi.this)
								.setTitle("Ýp Ucu:").setMessage(s.substring(0, s.length()- (s.length() - 5)) + " : " + meaning)
								.setPositiveButton("Tamam",
								new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
										}
							...
							if(s.length()==6){
								new AlertDialog.Builder(Muhallebi.this)
								.setTitle("Ýp Ucu:").setMessage(s.substring(0, s.length()- (s.length() -6)) + " : " + meaning)
								.setPositiveButton("Tamam",
								new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
										}
		...
		leave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				bundle.putString("muhallebi_count", Long.toString(getCount()));
	...
	private int getCount()
	{
		...
		final DatabaseHelper myDbHelper = new DatabaseHelper(this);
		int account_id =Integer.parseInt(account_ids);
		count = (int) myDbHelper.GetCountFindMuhallebiWords(account_id);
		myDbHelper.close();
		return count;
	}
	...
	private void DatabasedeAra(String cevapk) {
    	...
    	Cursor c1 = myDbHelper.GetFindedWordsMuhallebi(account_id);
    	...
    	Cursor c2 = myDbHelper.GetMuhallebiWords();
    	...
    	if(cevapk.compareToIgnoreCase(c2.getString(c2.getColumnIndex("wordname"))) == 0){
			...
			myDbHelper.InsertFindedWordMuhallebi(account_id,cevapk); 
    		...
    		int Muhallebi_puan = (int) myDbHelper.GetMuhallebiScore(account_id) + ((cevapk.length() * 5 )) ;
	...
	public void runAnimate()
	{
		...
		imgView = (ImageView) findViewById ( R.id.muhallebi_anim);
        
        new CountDownTimer(75,150) {
        	
        	int[] array  = {R.drawable.muhallebi1,R.drawable.muhallebi2,R.drawable.muhallebi3,
        					R.drawable.muhallebi4,R.drawable.muhallebi5,R.drawable.muhallebi6,
        					R.drawable.muhallebi7,R.drawable.muhallebi8,R.drawable.muhallebi9,
        					R.drawable.muhallebi10,R.drawable.muhallebi11,R.drawable.muhallebi12};
