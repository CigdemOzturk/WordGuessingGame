...
public class Pismaniye extends Activity implements SensorListener,Runnable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pismaniye);
        ...
        id = (int)myDbHelper.GetCountFindPismaniyeWords(account_id);
        
        Text= new String[id+5];
        int j=0;
        
        cr = myDbHelper.GetFindedWordsPismaniye(account_id);
        while(cr.moveToNext()){	
        ...
        gallery.setOnItemClickListener(new OnItemClickListener() {
  	      public void onItemClick(AdapterView<?> parent, View v,int position, long id) {
  	       ...
  	       {  
  	        	...
  	        	new AlertDialog.Builder(Pismaniye.this)
	...
	private void implement() {
		...
		facebook.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				bundle.putString("dessert_name","Pismaniye");
			...
			public void onClick(View arg0) {
				...
				if(new_word )
				{
					//getting hint words
					 ...
					 Cursor crr = hintHelper.GetNotFindedWords(account_id, 3);
					 int h=0;
				...
				// Button Enable - Disable Issues
					...
					int Pismaniye_puan = (int) myDbHelper.GetPismaniyeScore(account_id) - 5 ;
		 	    	int total_puan = (int) myDbHelper.GetTotalScore(account_id) - 5;
		    		myDbHelper.UpdatePismaniyeScore(Integer.toString(Pismaniye_puan), Integer.toString(account_id));
		...
		leave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				bundle.putString("pismaniye_count", Long.toString(getCount()));
	...
	private int getCount()
	{
		...
		final DatabaseHelper myDbHelper = new DatabaseHelper(this);
		int account_id =Integer.parseInt(account_ids);
		count = (int) myDbHelper.GetCountFindPismaniyeWords(account_id);
		myDbHelper.close();
		return count;
	}
	...
	private void DatabasedeAra(String cevapk) {
    	...
    	Cursor c1 = myDbHelper.GetFindedWordsPismaniye(account_id);
    	...
    	Cursor c2 = myDbHelper.GetPismaniyeWords();
    	...
    	if(cevapk.compareToIgnoreCase(c2.getString(c2.getColumnIndex("wordname"))) == 0){
			...
			myDbHelper.InsertFindedWordPismaniye(account_id,cevapk); 
    		...
    		int Pismaniye_puan = (int) myDbHelper.GetPismaniyeScore(account_id) + ((cevapk.length() * 5 )) ;
	...
	public void runAnimate()
	{
		...
		imgView = (ImageView) findViewById ( R.id.pismaniye_anim);
        
        new CountDownTimer(75,150) {
        	
        	int[] array  = {R.drawable.pismaniye1,R.drawable.pismaniye2,R.drawable.pismaniye3,
        					R.drawable.pismaniye4,R.drawable.pismaniye5,R.drawable.pismaniye6,
        					R.drawable.pismaniye7};
