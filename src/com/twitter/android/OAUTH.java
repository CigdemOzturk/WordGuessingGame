...
import tr.edu.khas.tatliavcisi.Twitter;
...
public class OAUTH extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		if(Twitter.account_id != null && Twitter.dessert_name != null){
		account_id = Twitter.account_id;
		dessert_name = Twitter.dessert_name;
		}
	...
	protected void onResume() {
		...
		if (uri != null && CALLBACK_URI.getScheme().equals(uri.getScheme())) {
			...
			Intent i = new Intent(this, Twitter.class);
			 // Currently, how we get back to main activity.
